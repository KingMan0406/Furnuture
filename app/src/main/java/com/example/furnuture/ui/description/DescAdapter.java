package com.example.furnuture.ui.description;
...
import com.example.furnuture.databinding.ItemDescCardBinding;
...
public class DescAdapter extends RecyclerView.Adapter<DescAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        public ViewHolder(@NonNull ItemDescCardBinding itemDescCardBinding){

            super(itemDescCardBinding.getRoot());
    }
